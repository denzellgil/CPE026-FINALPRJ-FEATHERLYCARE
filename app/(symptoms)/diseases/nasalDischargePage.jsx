    ...
    <SafeAreaView className="bg-cadetblue w-full h-full">
      ...
      <View className="flex-1">
        <TouchableOpacity onPress={() => router.back()} className="ml-5 mt-5">
          ...
          <Text className="text-center font-pextrabold text-3xl pt-20 mb-5">NASAL DISCHARGE</Text>
          <View>
            ...
            <View>
              <Text className="text-center font-pbold text-2xl underline mb-5">AVIAN MYCOPLASMOSIS</Text>
                <View>
                  <Text className="text-center font-pregular text-lg mt-3 mb-5 mx-2">  
                    Avian mycoplasmosis is a bacterial infection in birds caused primarily by
                    Mycoplasma gallisepticum and Mycoplasma synoviae. It affects the respiratory
                    system, leading to symptoms such as coughing, nasal discharge, and conjunctivitis,
                    and can also cause joint infections and reproductive issues. The disease poses significant
                    economic challenges for the poultry industry due to decreased productivity, increased mortality,
                    and the need for ongoing management and control measures.           
                  </Text>
                  <View className="items-center justify-center">
                    <Image 
                      source={images.mycoplasmosis}
                      className="items-center justify-center w-80 h-80"
                      resizeMode='contain'
                    />
                    <Link href="https://www.msdvetmanual.com/poultry/mycoplasmosis/mycoplasma-gallisepticum-infection-in-poultry" 
                    className='text-lg underline text-black mb-10 mt-6'>Click here for more info</Link>
                    </View>
                </View>
            </View>
...
export default nasalDischargePage